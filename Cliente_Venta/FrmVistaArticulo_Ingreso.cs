...
namespace Cliente_Venta
{
    ...
    {
        ServiceArticulo.Service_ArticuloClient sa = new ServiceArticulo.Service_ArticuloClient();
        ...
        {
            this.dataListado.DataSource = sa.Mostrar();
        ...
        {
            this.dataListado.DataSource = sa.BuscarNombre(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
